...
static    GLuint    yGOD__godball      (float a_side);
static    GLuint    yGOD__godbox       (float a_side);
static    GLuint    yGOD__godcross     (float a_side);
...
yGOD_start (void)
{
   ...
   dl_pyramid   = yGOD__pyramid (1.75, 'n');
